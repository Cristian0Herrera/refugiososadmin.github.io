...
return [
    ...
    /*
     ...
     |
     | Google STRONGLY ENCOURAGED you to set a region code (US, GB, etc) which they use to bias the 
     |
     | https://developers.google.com/maps/coverage
     |
     | Google discourage you from setting a language, as they feel this should be 
     | and only controls localization of the UI.  However, you may set your language in one of tw
     | FILAMENT_GOOGLE_MAPS_LANGUAGE_CODE, then server side calls (like static maps) where there
     | use your selected language.  If you set FILAMENT_GOOGLE_MAPS_API_LANGUAGE_CODE, then ALL 
