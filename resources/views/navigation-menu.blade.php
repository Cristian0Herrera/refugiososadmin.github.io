                        ...
                        <x-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    ...
                                    bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button class="flex text-sm border-2 border-transparent 
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    ...
                                    py-2 border border-transparent text-sm leading-4 font-medium 
