<x-action-section>
    ...
    <x-slot name="content">
                        ...
                        <div>
                            @if ($session->agent->isDesktop())
                                ...
                                class="w-8 h-8 text-gray-500">
                                    ...
                                    0018.75 3H5.25A2.25 2.25 0 003 5.25m18 0V12a2.25 
                            ...
                            @else
                                ...
                                class="w-8 h-8 text-gray-500">
                                    <path stroke-linecap="round" stroke-linejoin="round" 
                                    d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 
                                    0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 
                                    0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                                </svg>
                            @endif
                        </div>
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Please enter your password to confirm you would like to 
                log out of your other browser sessions across all of your devices.') }}

                <div class="mt-4" x-data="{}" x-on:confirming-logout-other-browser-sessions.window=
