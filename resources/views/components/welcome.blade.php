<div class="p-6 lg:p-8 bg-white border-b border-gray-200">
    ...
    <p class="mt-6 text-gray-500 leading-relaxed">
        ...
        Laravel application. 
        Laravel is designedto help you build your application using a development 
        environment that is simple, 
        powerful, and enjoyable. We believe you should love expressing your creativity 
        through programming, 
        so we have spent time carefully crafting the Laravel ecosystem to be a 
        breath of fresh air. We hope you love it.
    </p>
</div>

<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 
md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        <div class="flex items-center">
            ...
            stroke-width="1.5" class="w-6 h-6 stroke-gray-400">
                ...
                016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 
        ...
        <p class="mt-4 text-sm">
            <a href="https://laravel.com/docs" class="inline-flex items-center font-semibold text-indigo-700">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="ms-1 w-5 h-5 fill-indigo-500">
                    <path fill-rule="evenodd" d="M5 10a.75.75 0 01.75-.75h6.638L10.23 
                    7.29a.75.75 0 111.04-1.08l3.5 3.25a.75.75 0 010 1.08l-3.5 3.25a.75.75 
                    0 11-1.04-1.08l2.158-1.96H5.75A.75.75 0 015 10z" clip-rule="evenodd" />
                </svg>
            </a>
        </p>
    </div>
    ...
    <div>
        <div class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
            stroke-width="1.5" class="w-6 h-6 stroke-gray-400">
                <path stroke-linecap="round" d="M15.75 10.5l4.72-4.72a.75.75 0 
                011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 
                2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9A2.25 2.25 0 
    ...
    <div>
        <div class="flex items-center">
            ...
            stroke-width="1.5" class="w-6 h-6 stroke-gray-400">
                ...
                15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 
    ...
    <div>
        <div class="flex items-center">
            ...
            viewBox="0 0 24 24" stroke-width="1.5" class="w-6 h-6 stroke-gray-400">
                <path stroke-linecap="round" stroke-linejoin="round" 
        ...
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
            ...
            So, you're free to get started with what matters most: 
